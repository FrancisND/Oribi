        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateJoinded = table.Column<DateTime>(nullable: false),
                    Phone = table.Column<string>(nullable: true),
                    Designation = table.Column<string>(nullable: true),
                    Email = table.Column<string>(nullable: true),
                    InsuranceNo = table.Column<string>(maxLength: 50, nullable: false),
                    PaymentMethods = table.Column<int>(nullable: false),
                    StudentLoans = table.Column<int>(nullable: false),
                    UnionMembers = table.Column<int>(nullable: false),
